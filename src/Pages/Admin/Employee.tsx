      ...
      <div className="bg-white p-8 rounded-md w-full">
        <div className=" flex items-center justify-between pb-6">
          <div>
            ...
            <span className="text-xl">view employees status and activites</span>
          </div>
        ...
        <div>
          <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
            ...
            <div className="flex justify-between items-center">
              <div className="flex bg-gray-50 items-center p-2 rounded-md  w-1/2  mb-4 border-2 ">
                <svg
              ...
              <button className="bg-indigo-600 p-2  rounded-md text-white font-semibold tracking-wide cursor-pointer">
                Add Employee
              </button>
            </div>
