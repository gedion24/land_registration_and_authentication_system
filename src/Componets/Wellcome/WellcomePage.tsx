...
const WellcomePage = (props: Props) => {
  return (
    <>
      <section>
        <div className=" text-black py-20 h-screen bg-wellcomeimg bg-no-repeat bg-cover">
          <div className="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
            ...
            <div className="p-8 mt- mb- md:mb-0 md:mt-0 ml-0 md:ml-12 lg:w-2/3  justify-center">
