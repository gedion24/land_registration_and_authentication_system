                  ...
                  <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    ...
                    <div class="  ">
                      <div class="">
                        ...
                        <select class="block w-full px-8 py-2 mt-2 text-gray-800 bg-white border border-gray-300 rounded-md dark:bg-gray-100 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                          <option>Male</option>
                    ...
                    <div>
                      ...
                      <select class="block w-full px-4 py-2 mt-2 text-gray-100 bg-white border border-gray-300 rounded-md dark:bg-gray-100 dark:text-gray-800 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    ...
                    <div class="flex justify-between items-center">
                      <div class="">
                        ...
                        <input
                          ...
                          type="text"
                          disabled
                          class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-100 dark:text-gray-800 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                        />
                      </div>
                      <div class="  ">
